...
class EtuDev_Util_String
{
    ...
    static protected $rewrite_words_to_dash = array(
        '-be-',
        '-had-',
        '-it-',
        '-was-',
    ...
    static public function nameize($str, $a_char = array("'", "-", " "))
    {
        ...
        $string = preg_replace_callback(
            ...
            create_function('$matches', 'return $matches[1].mb_convert_case($matches[2], MB_CASE_UPPER, "UTF-8");'),
            $string
        );
    ...
    public static $repairHTMLTidyOptions = array(
        'wrap'           => 0,
        'doctype'        => 'omit',
        'tidy-mark'      => '0',
        'wrap-sections'  => '0',
